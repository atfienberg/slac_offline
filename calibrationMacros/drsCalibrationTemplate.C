...
void drsCalibrationTemplate(){
  const int numRuns = 8;
  const char* files[numRuns] = {
				"../crunchedFiles/run_00111_crunched_template.root",
				"../crunchedFiles/run_00112_crunched_template.root",
				"../crunchedFiles/run_00113_crunched_template.root",
				"../crunchedFiles/run_00114_crunched_template.root",
				"../crunchedFiles/run_00115_crunched_template.root",
				"../crunchedFiles/run_00116_crunched_template.root",
				"../crunchedFiles/run_00118_crunched_template.root",
  				"../crunchedFiles/run_00119_crunched_template.root"};
