calibrationMacro66(){
  const int numRuns = 9;
  const char* files[numRuns] = {"fullOpenCrunched.root", "closing1Crunched.root","closing2Crunched.root",
				"closing3Crunched.root", "closing4Crunched.root", "closing5Crunched.root",
				"closing6Crunched.root", "closing7Crunched.root", "closing8Crunched.root"};
