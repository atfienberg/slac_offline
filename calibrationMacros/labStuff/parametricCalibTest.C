parametricCalibTest(){
  ...
  const char* files[numRuns] = {
				"../crunchedFiles/run_00295_crunched_parametric.root",
				"../crunchedFiles/run_00296_crunched_parametric.root",
				"../crunchedFiles/run_00297_crunched_parametric.root",
				"../crunchedFiles/run_00298_crunched_parametric.root",
				"../crunchedFiles/run_00299_crunched_parametric.root",
				"../crunchedFiles/run_00300_crunched_parametric.root",
				"../crunchedFiles/run_00301_crunched_parametric.root"};
  ...
  for (int i = 0; i < numRuns; ++i){
    ...
    for (int j = 0; j < 4; ++j){
      t->Draw(Form("sipm%i.energy>>h%i(1000)",j+1,j),Form("sipm%i.valid",j+1));
