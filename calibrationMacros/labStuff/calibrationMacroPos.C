calibrationMacroPos(){
  const int numRuns = 9;
  const char* files[numRuns] = {"run_00108.root","run_00111.root","run_00113.root",
				"run_00114.root","run_00115.root","run_00116.root",
				"run_00117.root","run_00119.root","run_00120.root"};
