...
void uwItalianLaserCalib(){
  const int numRuns = 7;
  const char* files[numRuns] = {
				"../crunchedFiles/run_00295_crunched.root",
				"../crunchedFiles/run_00296_crunched.root",
				"../crunchedFiles/run_00297_crunched.root",
				"../crunchedFiles/run_00298_crunched.root",
				"../crunchedFiles/run_00299_crunched.root",
				"../crunchedFiles/run_00300_crunched.root",
				"../crunchedFiles/run_00301_crunched.root"};
