void italianCalib7_2(){
  const int numRuns = 6;
  const char* files[numRuns] = {"../crunchedFiles/run_00136_crunched.root",
				"../crunchedFiles/run_00137_crunched.root",
				"../crunchedFiles/run_00140_crunched.root",
				"../crunchedFiles/run_00142_crunched.root",
				"../crunchedFiles/run_00143_crunched.root",
				"../crunchedFiles/run_00145_crunched.root",
  				"../crunchedFiles/run_00147_crunched.root"};
