...
void howManyPEWRONG(){
  ...
  const char* files[numRuns] = {
				"../crunchedFiles/run_00393_wrong.root",
				"../crunchedFiles/run_00394_wrong.root",
				"../crunchedFiles/run_00395_wrong.root",
				"../crunchedFiles/run_00398_wrong.root",
				"../crunchedFiles/run_00399_wrong.root",
				"../crunchedFiles/run_00400_wrong.root"
				};
