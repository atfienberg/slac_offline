bool valid(TH1F* hist, int col){
  ...
  if(col > 5){
    bool rv = mean < 20000 && mean>200;
    return rv;
  }
  else{
    bool rv = mean<25000 && mean>300;
    return rv;
  }
...
void howManyPe(){
  ...
  const char* files[numRuns] = {
    "../../../crunchedFiles/run_00893_crunched.root",
    "../../../crunchedFiles/run_00888_crunched.root",
    "../../../crunchedFiles/run_00889_crunched.root",
    "../../../crunchedFiles/run_00890_crunched.root",
    "../../../crunchedFiles/run_00892_crunched.root" 
				};
